...
public:
    ...
    */
    ...
    Eigen::Vector3d getGlobalPosition();
...
private:
    ...
    // Novo: subscription e armazenamento thread-safe para posição global (lat, lon, alt)
    ...
    Eigen::Vector3d gps_global_position_{0.0, 0.0, 0.0};
