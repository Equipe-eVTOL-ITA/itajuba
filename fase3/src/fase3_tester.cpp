...
#include "fase3/test/tester_state.hpp"


class Fase3TesterFSM : public fsm::FSM {
public:
    Fase3TesterFSM(
        ...
        // DYNAMIC GRID - Similar to fase3.cpp but adapted for testing -------
...
public:
    NodeFSM(std::shared_ptr<Drone> drone, std::shared_ptr<VisionNode> vision) 
        ...
        fsm_ = std::make_unique<Fase3TesterFSM>(drone_node_, vision_node_, params, target_shapes);
...
private:
    ...
    std::unique_ptr<Fase3TesterFSM> fsm_;
